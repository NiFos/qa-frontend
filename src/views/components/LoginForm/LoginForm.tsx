...
import { Container, TextField, Typography, RadioGroup, FormControlLabel, Radio, makeStyles, Button } from '@material-ui/core';
import { localization } from '../../../lib/localization';
import googleBtnSvg from '../../../assets/googleBtn.svg';
...
export function LoginForm(props: Props) {
  ...
  const submitBtnDisabled = authType === 'login' ? loginSubmitBtnDisabled : regSubmitBtnDisabled;
  ...
  return (
    <Container>
      ...
      <Oauth OauthHandler={props.oauthHandler} />
    </Container>
  );
}
...
function Oauth(props: OauthProps) {
  return (
    <Button
      ...
      color={'primary'}
      name={'google'}
      onClick={(e) => props.OauthHandler('google')}
      fullWidth
    >
      <img src={googleBtnSvg} alt='img' />
      Sign in with Google
    </Button>
  );
}
